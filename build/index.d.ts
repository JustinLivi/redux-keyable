...
export declare type ReducerMethod<State, ReducerAction extends FluxStandardAction<ActionType> = FluxStandardAction<ActionType>, ActionType extends string = ReducerAction['type']> = (state: Draft<State>, action: ReducerAction) => void | State;
export interface KeyableReducer<State, ReducerAction extends FluxStandardAction<ActionType> = FluxStandardAction<ActionType>, ActionType extends string = ReducerAction['type']> {
    type: ActionType;

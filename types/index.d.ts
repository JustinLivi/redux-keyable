...
export declare type ReducerMethod<
  State,
...
> = (params: Params) => A;
export declare const createActionCreator: <
  Params = never,
  A extends FluxStandardAction<ActionType, any, any> = never,
  ActionType extends string = A['type']
>(
  actionCreator: ActionCreator<Params, A, ActionType>
) => ActionCreator<Params, A, ActionType>;
export declare const createKeyableReducer: <
  State = never,
  ReducerAction extends FluxStandardAction<ActionType, any, any> = never,
  ActionType extends string = ReducerAction['type']
>(
  type: ActionType,
...
export declare const combineKeyableReducers: <State = never>(
  defaultState: State
) => (
  ...keyableReducers: KeyableReducer<State, any, any>[]
) => (
